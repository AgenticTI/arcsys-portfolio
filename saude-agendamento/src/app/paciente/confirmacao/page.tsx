  ...
  return (
    <div className="max-w-md mx-auto text-center">
      <div className="bg-white rounded-[20px] shadow-card p-8 flex flex-col items-center gap-6">
        ...
        <div>
          <h1 className="text-xl font-extrabold text-neutral-900">Consulta Agendada!</h1>
        ...
        {/* Summary */}
        <div className="bg-neutral-100 rounded-xl p-4 w-full text-left flex flex-col gap-3">
          {doctor && (
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <p className="font-bold text-neutral-900 text-sm">{doctor.name}</p>
          ...
          {time && (
            <div className="flex items-center gap-2 text-sm text-neutral-600">
              ...
              <span className="text-xs font-semibold text-neutral-900">{time}</span>
            </div>
          )}
        </div>
        ...
        <Link href="/paciente/dashboard" className="w-full">
          <button className="w-full bg-primary text-dark-card py-3 rounded-xl font-bold text-sm hover:bg-primary/90 transition-colors">
            Voltar ao Dashboard
          </button>
        </Link>
      </div>
